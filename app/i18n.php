...
function translations($lang) {
	$strings = [
		'en' => [
			...
			'progress_more' => '%s of about %s videos of %s checked. Load more checks the next set from YouTube.',
		...
		'fr' => [
			...
			'free_videos_found' => '%s vidéos sous licence libre trouvées',
				...
				'free_videos_found_of' => '%s d’environ %s vidéos sous licence libre trouvées',
