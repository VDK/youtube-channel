...
function translations($lang) {
	$strings = [
		'en' => [
			...
			'progress_more' => '%s of %s videos of %s checked.',
			'progress_stopped' => '%s of %s videos of %s checked. Load more is hidden because YouTube stopped giving this tool more results, even though it still reports more videos.',
			'progress_done' => '%s of %s videos of %s checked. YouTube returned no more results to check.',
		...
		'nl' => [
			...
			'progress_more' => '%s van %s passende video\'s van %s gecontroleerd.',
			'progress_stopped' => '%s van %s passende video\'s van %s gecontroleerd. Meer laden is verborgen omdat YouTube deze tool geen verdere resultaten meer geeft, hoewel YouTube nog wel meer passende video\'s meldt.',
			'progress_done' => '%s van %s passende video\'s van %s gecontroleerd. YouTube gaf geen verdere resultaten om te controleren.',
		...
		'fr' => [
			...
			'progress_more' => '%s sur %s vid├®os correspondantes de %s v├®rifi├®es.',
			'progress_stopped' => '%s sur %s vid├®os correspondantes de %s vérifiées. Charger plus est masqué car YouTube ne donne plus de résultats à cet outil, même s’il signale encore plus de vidéos correspondantes.',
			'progress_done' => '%s sur %s vid├®os correspondantes de %s vérifiées. YouTube n’a renvoyé aucun autre résultat à vérifier.',
		...
		'de' => [
			...
			'progress_more' => '%s von %s passenden Videos von %s geprüft.',
			'progress_stopped' => '%s von %s passenden Videos von %s geprüft. Mehr laden ist ausgeblendet, weil YouTube diesem Tool keine weiteren Ergebnisse gibt, obwohl YouTube weitere passende Videos meldet.',
			'progress_done' => '%s von %s passenden Videos von %s geprüft. YouTube hat keine weiteren Ergebnisse zum Prüfen geliefert.',
		...
		'es' => [
			...
			'progress_more' => '%s de %s videos coincidentes de %s comprobados.',
			'progress_stopped' => '%s de %s videos coincidentes de %s comprobados. Cargar más está oculto porque YouTube dejó de dar más resultados a esta herramienta, aunque todavía indica más videos coincidentes.',
			'progress_done' => '%s de %s videos coincidentes de %s comprobados. YouTube no devolvió más resultados para comprobar.',
