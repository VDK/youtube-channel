...
function translations($lang) {
	$strings = [
		...
		'nl' => [
			...
			'progress_more' => '%s van %s video\'s van %s gecontroleerd.',
		...
		'fr' => [
			...
			'progress_more' => '%s sur %s vid├®os de %s v├®rifi├®es.',
		...
		'de' => [
			...
			'progress_more' => '%s von %s Videos von %s geprüft.',
		...
		'es' => [
			...
			'progress_more' => '%s de %s videos de %s comprobados.',
			'progress_stopped' => '%s de %s videos de %s comprobados. Cargar más está oculto porque YouTube dejó de dar más resultados a esta herramienta, aunque todavía indica más videos coincidentes.',
			'progress_done' => '%s de %s videos de %s comprobados. YouTube no devolvió más resultados para comprobar.',
